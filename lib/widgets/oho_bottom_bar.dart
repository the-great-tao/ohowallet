...
class OHOBottomBarController extends BaseController {}

class OHOBottomBar extends BaseWidget<OHOBottomBarController> {
  ...
  }) : super(controller: OHOBottomBarController());

  /// A list of tabs to display, ie `Home`, `Likes`, etc
  final List<OHOBottomBarItem> items;
                        ...
                        child: Padding(
                          padding: itemPadding -
                              (Directionality.of(context) == TextDirection.ltr
                                  ? EdgeInsets.only(
                                      right: itemPadding.right * tweenValue)
                                  : EdgeInsets.only(
                                      left: itemPadding.left * tweenValue)),
                          child: Row(
                            children: [
                              IconTheme(
                                data: IconThemeData(
...
/// A tab to display in a [OHOBottomBar]
class OHOBottomBarItem {
  /// An icon to display.
  final Widget icon;
