...
part 'one_inch_aggregation.swagger.chopper.dart';
part 'one_inch_aggregation.swagger.g.dart';
...
@ChopperApi()
abstract class OneInchAggregation extends ChopperService {
  static OneInchAggregation create({
    ...
    if (client != null) {
      return _$OneInchAggregation(client);
    }

    final newClient = ChopperClient(
        services: [_$OneInchAggregation()],
        converter: $JsonSerializableConverter(),
        interceptors: interceptors ?? [],
        authenticator: authenticator,
        baseUrl: baseUrl ?? 'http://');
    return _$OneInchAggregation(newClient);
  }
