...
part of 'one_inch_aggregation_fantom.swagger.dart';
...
class _$OneInchAggregationFantom extends OneInchAggregationFantom {
  _$OneInchAggregationFantom([ChopperClient? client]) {
  ...
  Future<Response<ApproveCalldataResponseDto>>
    ...
    final String $url = '/v4.0/250/approve/transaction';
  ...
  Future<Response<dynamic>> _ChainApproveController_getAllowance({
    ...
    final String $url = '/v4.0/250/approve/allowance';
    final Map<String, dynamic> $params = <String, dynamic>{
      'tokenAddress': tokenAddress,
  ...
  Future<Response<QuoteResponseDto>> _ExchangeController_getQuote({
    ...
    final String $url = '/v4.0/250/quote';
    final Map<String, dynamic> $params = <String, dynamic>{
  ...
  Future<Response<SwapResponseDto>> _ExchangeController_getSwap({
    ...
    final String $url = '/v4.0/250/swap';
    final Map<String, dynamic> $params = <String, dynamic>{
      'fromTokenAddress': fromTokenAddress,
      'toTokenAddress': toTokenAddress,
      'amount': amount,
