...
part 'one_inch_aggregation_avalanche.swagger.chopper.dart';
part 'one_inch_aggregation_avalanche.swagger.g.dart';
...
@ChopperApi()
abstract class OneInchAggregationAvalanche extends ChopperService {
  static OneInchAggregationAvalanche create({
    ...
    if (client != null) {
      return _$OneInchAggregationAvalanche(client);
    }

    final newClient = ChopperClient(
        services: [_$OneInchAggregationAvalanche()],
        converter: $JsonSerializableConverter(),
        interceptors: interceptors ?? [],
        authenticator: authenticator,
        baseUrl: baseUrl ?? 'http://');
    return _$OneInchAggregationAvalanche(newClient);
  }
