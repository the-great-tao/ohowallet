...
part of 'one_inch_aggregation_ethereum.swagger.dart';
...
class _$OneInchAggregationEthereum extends OneInchAggregationEthereum {
  _$OneInchAggregationEthereum([ChopperClient? client]) {
  ...
  Future<Response<ApproveCalldataResponseDto>>
    ...
    final String $url = '/v4.0/1/approve/transaction';
  ...
  Future<Response<dynamic>> _ChainApproveController_getAllowance({
    ...
    final String $url = '/v4.0/1/approve/allowance';
    final Map<String, dynamic> $params = <String, dynamic>{
      'tokenAddress': tokenAddress,
