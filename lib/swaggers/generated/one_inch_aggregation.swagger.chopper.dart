...
part of 'one_inch_aggregation.swagger.dart';
...
class _$OneInchAggregation extends OneInchAggregation {
  _$OneInchAggregation([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final definitionType = OneInchAggregation;
  ...
  Future<Response<ApproveSpenderResponseDto>>
    ...
    final String $url = '/approve/spender';
    final Request $request = Request(
      'GET',
      $url,
      client.baseUrl,
  ...
  Future<Response<ApproveCalldataResponseDto>>
    ...
    final String $url = '/approve/transaction';
  ...
  Future<Response<dynamic>> _ChainApproveController_getAllowance({
    ...
    final String $url = '/approve/allowance';
    final Map<String, dynamic> $params = <String, dynamic>{
      'tokenAddress': tokenAddress,
  ...
  Future<Response<ProtocolsResponseDto>>
    ...
    final String $url = '/liquidity-sources';
    final Request $request = Request(
      'GET',
      $url,
      client.baseUrl,
