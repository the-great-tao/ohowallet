...
class TermsOfUseScreenController extends BaseController {
...
class TermsOfUseScreen extends BaseWidget<TermsOfUseScreenController> {
  TermsOfUseScreen({
    super.key,
  }) : super(controller: TermsOfUseScreenController());
